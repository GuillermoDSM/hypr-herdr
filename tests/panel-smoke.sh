...
cp "$repo_dir/Panel.qml" "$repo_dir/HerdrClient.qml" "$repo_dir/WorkspaceLease.qml" "$repo_dir/WorkspaceManager.qml" "$repo_dir/IdCodec.js" "$repo_dir/LayoutSync.js" "$repo_dir/LeaseCodec.js" "$tmp_dir/"

...
Item {
  ...
  function acquire(spaceId) {
    ...
    var code = "function() "
      ...
      + "or hl.get_workspace(" + luaString("id:" + parking) + ") then return end; "
  ...
  function switchSpace(spaceId) {
    ...
    var code = "function() "
      ...
      + "if not owner or not target or hl.get_workspace(" + luaString("id:" + owner.parsed.homeId) + ") then return end; "
  ...
  function migrate(spaceId) {
    ...
    var code = "function() local source = hl.get_active_workspace(); "
      ...
      + "or hl.get_workspace(" + luaString("id:" + owner.parsed.homeId) + ") "
      + "or hl.get_workspace(" + luaString("id:" + newParking) + ") then return end; "
      + "hl.dispatch(hl.dsp.workspace.rename({ workspace = owner, name = " + luaString(ownerStable) + " })); "
      + "hl.dispatch(hl.dsp.workspace.change_id({ workspace = owner, id = " + owner.parsed.homeId + " })); "
      + restoreOld
  ...
  function release() {
    ...
    var code = "function() "
      + "local owner = hl.get_workspace(" + luaString(namedWorkspace(workspaceName(owner.workspace))) + "); "
      + "if not owner or hl.get_workspace(" + luaString("id:" + homeId) + ") then return end; "
